import { 
  ...
  TreatmentPlan, Prescription, InventoryItem, Invoice, LabOrder 
} from '../types';
...
export const INITIAL_TEETH_MAP: Record<string, Record<number, ToothCondition>> = {
  'TKR-P-1001': {
...
export const INITIAL_TREATMENTS: TreatmentPlan[] = [
  {
    id: 'TP-101',
    patientId: 'TKR-P-1001',
    patientName: 'Rahul Verma',
